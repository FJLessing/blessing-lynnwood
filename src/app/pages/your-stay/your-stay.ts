...
export class YourStay {
  ...
  googleMapsUrl: SafeResourceUrl | null = environment.googleMapsApiKey
    ? this.sanitizer.bypassSecurityTrustResourceUrl(
        `https://www.google.com/maps/embed/v1/place?key=${environment.googleMapsApiKey}&q=358+Elizabeth+Grove+South,+Pretoria,+South+Africa,+0081`,
      )
    : null;
}
